import{h as M,E as p,i as _,M as E,j as B,k as G,m as L,n as P,o as S,b as Z,q as ee,t as te,e as v}from"./index-6bf2f6ad.js";import{g as A,M as I,a as re,c as O,f as ne,S as T,B as se,G as U,R as ie,b as w,d as oe,e as ae,h as ue,i as de}from"./SystemManager-46335f09.js";var C=`struct GlobalUniforms {
...
`;function ce(i){return A({vertex:{source:C,entryPoint:"mainVertex"},fragment:{source:C,entryPoint:"mainFragment"},maxTextures:i})}class F{init(){this.shader=new M({gpuProgram:ce(I),groups:{}})}execute(e,t){e.state.blendMode=t.blendMode,t.textures.bindGroup||(t.textures.bindGroup=re(t.textures.textures));const r=this.shader.gpuProgram,n=e.renderer.encoder,s=e.renderer.globalUniforms.bindGroup;this.shader.groups[1]=t.textures.bindGroup;const o=t.batchParent;n.setPipelineFromGeometryProgramAndState(o.geometry,r,e.state),n.setGeometry(o.geometry),n.setBindGroup(0,s,r),n.setBindGroup(1,t.textures.bindGroup,r),n.renderPassEncoder.drawIndexed(t.size,1,t.start)}destroy(){this.shader.destroy(!0),this.shader=null}}F.extension={type:[p.WebGPURendererPipesAdaptor],name:"batch"};var R=`struct GlobalUniforms {
  projectionMatrix:mat3x3<f32>,
  worldTransformMatrix:mat3x3<f32>,
  worldAlpha: f32
}
