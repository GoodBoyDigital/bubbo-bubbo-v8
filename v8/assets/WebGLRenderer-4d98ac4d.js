import{i as y,M as G,h as P,E as m,k as S,v as ve,b as g,t as X,q as $,e as I}from"./index-6bf2f6ad.js";import{j,M as Y,k as q,c as K,R as pe,b as w,S as O,G as Ee,B as Z,d as _e,e as ge,h as be,i as Te}from"./SystemManager-46335f09.js";var xe=`in vec2 vTextureCoord;
in vec4 vColor;
in float vTextureId;
...
`;function ye(t){return j({vertexSrc:Re,fragmentSrc:xe,maxTextures:t,name:"default"})}class Q{constructor(){this.didUpload=!1}init(){const e=new y({tint:{value:new Float32Array([1,1,1,1]),type:"f32"},translationMatrix:{value:new G,type:"mat3x3<f32>"}});this.shader=new P({glProgram:ye(Y),resources:{uniforms:e,batchSamplers:q}})}execute(e,r){const n=e.renderer;e.state.blendMode=r.blendMode,n.state.set(e.state),n.shader.bind(this.shader,this.didUpload),this.didUpload=!0;const i=r.batchParent;n.geometry.bind(i.geometry,this.shader.glProgram);for(let s=0;s<r.textures.textures.length;s++)n.texture.bind(r.textures.textures[s],s);n.shader.bindUniformBlock(n.globalUniforms.uniformGroup,"globalUniforms",0),n.geometry.draw("triangle-list",r.size,r.start)}destroy(){this.shader.destroy(!0),this.shader=null}}Q.extension={type:[m.WebGLRendererPipesAdaptor],name:"batch"};var Ie=`in vec2 vTextureCoord;
in vec4 vColor;
in float vTextureId;
uniform sampler2D uSamplers[%count%];
...
; // eslint-disable-line max-len
    ...
    `];for(const n in t.uniforms){const i=e[n];if(!i){t.uniforms[n]instanceof y?t.uniforms[n].ubo?r.push(`
                    ...
                    `);continue}const s=t.uniforms[n];let o=!1;for(let a=0;a<U.length;a++)if(U[a].test(i,s)){r.push(U[a].code(n,s)),o=!0;break}if(!o){const c=(i.size===1&&!i.isArray?Ve:We)[i.type].replace("location",`ud["${n}"].location`);r.push(`
            cu = ud["${n}"];
            cv = cu.value;
            v = uv["${n}"];
            ${c};`)}}return new Function("ud","uv","renderer","syncData",r.join(`
`))}class de{constructor(e){this.destroyed=!1,this.cache={},this.uniformGroupSyncHash={},this.renderer=e,this.systemCheck(),this.gl=null,this.cache={}}systemCheck(){if(!ke())throw new Error("Current environment does not allow unsafe-eval, please use @pixi/unsafe-eval module to enable support.")}contextChange(e){this.gl=e}updateUniformGroup(e,r,n){const i=this.renderer.shader.getProgramData(r);(!e.isStatic||e.dirtyId!==i.uniformDirtyGroups[e.uid])&&(i.uniformDirtyGroups[e.uid]=e.dirtyId,this.getUniformSyncFunction(e,r)(i.uniformData,e.uniforms,this.renderer,n))}getUniformSyncFunction(e,r){var n;return((n=this.uniformGroupSyncHash[e.signature])==null?void 0:n[r.key])||this.createUniformSyncFunction(e,r)}createUniformSyncFunction(e,r){const n=this.uniformGroupSyncHash[e.signature]||(this.uniformGroupSyncHash[e.signature]={}),i=this.getSignature(e,r.uniformData,"u");return this.cache[i]||(this.cache[i]=ze(e,r.uniformData)),n[r.key]=this.cache[i],n[r.key]}getSignature(e,r,n){const i=e.uniforms,s=[`${n}-`];for(const o in i)s.push(o),r[o]&&s.push(r[o].type);return s.join("-")}destroy(){this.renderer=null,this.destroyed=!0}}de.extension={type:[m.WebGLRendererSystem],name:"uniformGroup"};function Xe(t){const e={};return e.normal=[t.ONE,t.ONE_MINUS_SRC_ALPHA],e.add=[t.ONE,t.ONE],e.multiply=[t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA],e.screen=[t.ONE,t.ONE_MINUS_SRC_COLOR,t.ONE,t.ONE_MINUS_SRC_ALPHA],e.none=[0,0],e["normal-npm"]=[t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA],e["add-npm"]=[t.SRC_ALPHA,t.ONE,t.ONE,t.ONE],e["screen-npm"]=[t.SRC_ALPHA,t.ONE_MINUS_SRC_COLOR,t.ONE,t.ONE_MINUS_SRC_ALPHA],e}const $e=0,je=1,Ye=2,qe=3,Ke=4,Ze=5,F=class{constructor(){this.gl=null,this.stateId=0,this.polygonOffset=0,this.blendMode="none",this._blendEq=!1,this.map=[],this.map[$e]=this.setBlend,this.map[je]=this.setOffset,this.map[Ye]=this.setCullFace,this.map[qe]=this.setDepthTest,this.map[Ke]=this.setFrontFace,this.map[Ze]=this.setDepthMask,this.checks=[],this.defaultState=new X,this.defaultState.blend=!0}contextChange(t){this.gl=t,this.blendModesMap=Xe(t),this.set(this.defaultState),this.reset()}set(t){if(t=t||this.defaultState,this.stateId!==t.data){let e=this.stateId^t.data,r=0;for(;e;)e&1&&this.map[r].call(this,!!(t.data&1<<r)),e=e>>1,r++;this.stateId=t.data}for(let e=0;e<this.checks.length;e++)this.checks[e](this,t)}forceState(t){t=t||this.defaultState;for(let e=0;e<this.map.length;e++)this.map[e].call(this,!!(t.data&1<<e));for(let e=0;e<this.checks.length;e++)this.checks[e](this,t);this.stateId=t.data}setBlend(t){this.updateCheck(F.checkBlendMode,t),this.gl[t?"enable":"disable"](this.gl.BLEND)}setOffset(t){this.updateCheck(F.checkPolygonOffset,t),this.gl[t?"enable":"disable"](this.gl.POLYGON_OFFSET_FILL)}setDepthTest(t){this.gl[t?"enable":"disable"](this.gl.DEPTH_TEST)}setDepthMask(t){this.gl.depthMask(t)}setCullFace(t){this.gl[t?"enable":"disable"](this.gl.CULL_FACE)}setFrontFace(t){this.gl.frontFace(this.gl[t?"CW":"CCW"])}setBlendMode(t){if(this.blendModesMap[t]||(t="normal"),t===this.blendMode)return;this.blendMode=t;const e=this.blendModesMap[t],r=this.gl;e.length===2?r.blendFunc(e[0],e[1]):r.blendFuncSeparate(e[0],e[1],e[2],e[3]),e.length===6?(this._blendEq=!0,r.blendEquationSeparate(e[4],e[5])):this._blendEq&&(this._blendEq=!1,r.blendEquationSeparate(r.FUNC_ADD,r.FUNC_ADD))}setPolygonOffset(t,e){this.gl.polygonOffset(t,e)}reset(){this.gl.pixelStorei(this.gl.UNPACK_FLIP_Y_WEBGL,!1),this.forceState(this.defaultState),this._blendEq=!0,this.blendMode="",this.setBlendMode("normal")}updateCheck(t,e){const r=this.checks.indexOf(t);e&&r===-1?this.checks.push(t):!e&&r!==-1&&this.checks.splice(r,1)}static checkBlendMode(t,e){t.setBlendMode(e.blendMode)}static checkPolygonOffset(t,e){t.setPolygonOffset(1,e.polygonOffset)}destroy(){this.gl=null}};let he=F;he.extension={type:[m.WebGLRendererSystem],name:"state"};class Qe{constructor(e){this.target=re.TEXTURE_2D,this.texture=e,this.width=-1,this.height=-1,this.type=f.UNSIGNED_BYTE,this.internalFormat=C.RGBA,this.format=C.RGBA,this.samplerType=0}}const Je={type:"image",upload(t,e,r){e.width===t.width||e.height===t.height?r.texSubImage2D(r.TEXTURE_2D,0,0,0,e.format,e.type,t.resource):r.texImage2D(e.target,0,e.internalFormat,t.width,t.height,0,e.format,e.type,t.resource),e.width=t.width,e.height=t.height}},et={type:"image",upload(t,e,r){r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.alphaMode!==0),e.width===t.width||e.height===t.height?r.texSubImage2D(r.TEXTURE_2D,0,0,0,e.format,e.type,t.resource):r.texImage2D(e.target,0,e.internalFormat,t.pixelWidth,t.pixelHeight,0,e.format,e.type,t.resource),e.width=t.pixelWidth,e.height=t.pixelHeight}};function tt(t){return{r8unorm:t.RED,r8snorm:t.RED,r8uint:t.RED,r8sint:t.RED,r16uint:t.RED,r16sint:t.RED,r16float:t.RED,rg8unorm:t.RG,rg8snorm:t.RG,rg8uint:t.RG,rg8sint:t.RG,r32uint:t.RED,r32sint:t.RED,r32float:t.RED,rg16uint:t.RG,rg16sint:t.RG,rg16float:t.RG,rgba8unorm:t.RGBA,"rgba8unorm-srgb":t.RGBA,rgba8snorm:t.RGBA,rgba8uint:t.RGBA,rgba8sint:t.RGBA,bgra8unorm:t.RGBA,"bgra8unorm-srgb":t.RGBA,rgb9e5ufloat:t.RGB,rgb10a2unorm:t.RGBA,rg11b10ufloat:t.RGB,rg32uint:t.RG,rg32sint:t.RG,rg32float:t.RG,rgba16uint:t.RGBA,rgba16sint:t.RGBA,rgba16float:t.RGBA,rgba32uint:t.RGBA,rgba32sint:t.RGBA,rgba32float:t.RGBA,stencil8:t.STENCIL_INDEX8,depth16unorm:t.DEPTH_COMPONENT,depth24plus:t.DEPTH_COMPONENT,"depth24plus-stencil8":t.DEPTH_STENCIL,depth32float:t.DEPTH_COMPONENT,"depth32float-stencil8":t.DEPTH_STENCIL}}function rt(t){return{r8unorm:t.R8,r8snorm:t.R8_SNORM,r8uint:t.R8UI,r8sint:t.R8I,r16uint:t.R16UI,r16sint:t.R16I,r16float:t.R16F,rg8unorm:t.RG8,rg8snorm:t.RG8_SNORM,rg8uint:t.RG8UI,rg8sint:t.RG8I,r32uint:t.R32UI,r32sint:t.R32I,r32float:t.R32F,rg16uint:t.RG16UI,rg16sint:t.RG16I,rg16float:t.RG16F,rgba8unorm:t.RGBA,"rgba8unorm-srgb":t.SRGB8_ALPHA8,rgba8snorm:t.RGBA8_SNORM,rgba8uint:t.RGBA8UI,rgba8sint:t.RGBA8I,bgra8unorm:t.RGBA8,"bgra8unorm-srgb":t.SRGB8_ALPHA8,rgb9e5ufloat:t.RGB9_E5,rgb10a2unorm:t.RGB10_A2,rg11b10ufloat:t.R11F_G11F_B10F,rg32uint:t.RG32UI,rg32sint:t.RG32I,rg32float:t.RG32F,rgba16uint:t.RGBA16UI,rgba16sint:t.RGBA16I,rgba16float:t.RGBA16F,rgba32uint:t.RGBA32UI,rgba32sint:t.RGBA32I,rgba32float:t.RGBA32F,stencil8:t.STENCIL_INDEX8,depth16unorm:t.DEPTH_COMPONENT16,depth24plus:t.DEPTH_COMPONENT24,"depth24plus-stencil8":t.DEPTH24_STENCIL8,depth32float:t.DEPTH_COMPONENT32F,"depth32float-stencil8":t.DEPTH32F_STENCIL8}}function nt(t){return{r8unorm:t.UNSIGNED_BYTE,r8snorm:t.BYTE,r8uint:t.UNSIGNED_BYTE,r8sint:t.BYTE,r16uint:t.UNSIGNED_SHORT,r16sint:t.SHORT,r16float:t.HALF_FLOAT,rg8unorm:t.UNSIGNED_BYTE,rg8snorm:t.BYTE,rg8uint:t.UNSIGNED_BYTE,rg8sint:t.BYTE,r32uint:t.UNSIGNED_INT,r32sint:t.INT,r32float:t.FLOAT,rg16uint:t.UNSIGNED_SHORT,rg16sint:t.SHORT,rg16float:t.HALF_FLOAT,rgba8unorm:t.UNSIGNED_BYTE,"rgba8unorm-srgb":t.UNSIGNED_BYTE,rgba8snorm:t.BYTE,rgba8uint:t.UNSIGNED_BYTE,rgba8sint:t.BYTE,bgra8unorm:t.UNSIGNED_BYTE,"bgra8unorm-srgb":t.UNSIGNED_BYTE,rgb9e5ufloat:t.UNSIGNED_INT_5_9_9_9_REV,rgb10a2unorm:t.UNSIGNED_INT_2_10_10_10_REV,rg11b10ufloat:t.UNSIGNED_INT_10F_11F_11F_REV,rg32uint:t.UNSIGNED_INT,rg32sint:t.INT,rg32float:t.FLOAT,rgba16uint:t.UNSIGNED_SHORT,rgba16sint:t.SHORT,rgba16float:t.HALF_FLOAT,rgba32uint:t.UNSIGNED_INT,rgba32sint:t.INT,rgba32float:t.FLOAT,stencil8:t.UNSIGNED_BYTE,depth16unorm:t.UNSIGNED_SHORT,depth24plus:t.UNSIGNED_INT,"depth24plus-stencil8":t.UNSIGNED_INT_24_8,depth32float:t.FLOAT,"depth32float-stencil8":t.FLOAT_32_UNSIGNED_INT_24_8_REV}}const z={linear:9729,nearest:9728},it={linear:{linear:9987,nearest:9985},nearest:{linear:9986,nearest:9984}},D={"clamp-to-edge":33071,repeat:10497,"mirror-repeat":33648},st={never:512,less:513,equal:514,"less-equal":515,greater:516,"not-equal":517,"greater-equal":518,always:519};class me{constructor(e){this.glTextures={},this.glSamplers={},this.boundTextures=[],this.boundTexturesSamplers=[],this.activeTextureLocation=-1,this.boundSamplers={},this.managedTextureSources={},this.uploads={image:et,buffer:Je},this.renderer=e}contextChange(e){this.gl=e,this.mapFormatToInternalFormat||(this.mapFormatToInternalFormat=rt(e),this.mapFormatToType=nt(e),this.mapFormatToFormat=tt(e));for(let r=0;r<16;r++)this.bind(g.EMPTY,r)}bind(e,r=0){e?(this.bindSource(e.source,r),this.bindSampler(e.style,r)):(this.bindSource(null,r),this.bindSampler(null,r))}bindSource(e,r=0){const n=this.gl;if(this.boundTextures[r]!==e){this.boundTextures[r]=e,this.activateLocation(r),e=e||g.EMPTY.source;const i=this.getGlSource(e);n.bindTexture(i.target,i.texture)}}bindSampler(e,r=0){const n=this.gl;if(!e){this.boundSamplers[r]=null,n.bindSampler(r,null);return}const i=this.getGlSampler(e);this.boundSamplers[r]!==i&&(this.boundSamplers[r]=i,n.bindSampler(r,i))}unbind(e){const r=e.source,n=this.boundTextures,i=this.gl;for(let s=0;s<n.length;s++)if(n[s]===r){this.activateLocation(s);const o=this.getGlSource(r);i.bindTexture(o.target,null),n[s]=null}}activateLocation(e){this.activeTextureLocation!==e&&(this.activeTextureLocation=e,this.gl.activeTexture(this.gl.TEXTURE0+e))}initSource(e){const r=this.gl,n=new Qe(r.createTexture());if(n.type=this.mapFormatToType[e.format],n.internalFormat=this.mapFormatToInternalFormat[e.format],n.format=this.mapFormatToFormat[e.format],e.autoGenerateMipmaps){const i=Math.max(e.width,e.height);e.mipLevelCount=Math.floor(Math.log2(i))+1}return this.glTextures[e.uid]=n,e.on("update",this.onSourceUpdate,this),e.on("destroy",this.onSourceDestroy,this),this.onSourceUpdate(e),n}onSourceUpdate(e){const r=this.gl,n=this.glTextures[e.uid];r.bindTexture(r.TEXTURE_2D,n.texture),this.boundTextures[this.activeTextureLocation]=e,this.uploads[e.type]?(this.uploads[e.type].upload(e,n,this.gl),e.autoGenerateMipmaps&&e.mipLevelCount>1&&r.generateMipmap(n.target)):r.texImage2D(r.TEXTURE_2D,0,r.RGBA,e.pixelWidth,e.pixelHeight,0,r.RGBA,r.UNSIGNED_BYTE,null)}onSourceDestroy(e){const r=this.gl;e.off("destroy",this.onSourceDestroy,this),e.off("update",this.onSourceUpdate,this);const n=this.glTextures[e.uid];delete this.glTextures[e.uid],r.deleteTexture(n.target)}initSampler(e){const r=this.gl,n=this.gl.createSampler();if(this.glSamplers[e.resourceId]=n,r.samplerParameteri(n,r.TEXTURE_WRAP_S,D[e.addressModeU]),r.samplerParameteri(n,r.TEXTURE_WRAP_T,D[e.addressModeV]),r.samplerParameteri(n,r.TEXTURE_WRAP_R,D[e.addressModeW]),r.samplerParameteri(n,r.TEXTURE_MAG_FILTER,z[e.minFilter]),this.boundTextures[this.activeTextureLocation].mipLevelCount>1){const s=it[e.minFilter][e.mipmapFilter];r.samplerParameteri(n,r.TEXTURE_MIN_FILTER,s)}else r.samplerParameteri(n,r.TEXTURE_MIN_FILTER,z[e.magFilter]);const i=this.renderer.context.extensions.anisotropicFiltering;if(i&&e.maxAnisotropy>1){const s=Math.min(e.maxAnisotropy,r.getParameter(i.MAX_TEXTURE_MAX_ANISOTROPY_EXT));r.samplerParameteri(n,i.TEXTURE_MAX_ANISOTROPY_EXT,s)}return e.compare&&r.samplerParameteri(n,r.TEXTURE_COMPARE_FUNC,st[e.compare]),this.glSamplers[e.resourceId]}getGlSampler(e){return this.glSamplers[e.resourceId]||this.initSampler(e)}getGlSource(e){return this.glTextures[e.uid]||this.initSource(e)}destroy(){throw new Error("Method not implemented.")}}me.extension={type:[m.WebGLRendererSystem],name:"texture"};const ot=[ie,N,te,me,ae,ne,de,fe,oe,he,ce,se,Q,ee,J],R=class extends _e{constructor(){super(),this.type="webgl",this.renderPipes={};const t={runners:["init","destroy","contextChange","reset","update","postrender","prerender","resize"],systems:R.__systems,pipes:R.__pipes},e={...R.__pipesAdaptors};Object.keys(t.pipes).forEach(r=>{var o;const n=t.pipes[r],i=(o=e[r])==null?void 0:o.adaptor,s=r;i?this.renderPipes[s]=new n(this,new i):this.renderPipes[s]=new n(this)}),this.setup(t)}resize(t,e,r){this.view.resizeView(t,e,r)}async init(t){t=Object.assign({},{...ge,...N.defaultOptions},t),this.options=t,this.startup.run(this.options)}render(t,e){e instanceof HTMLCanvasElement&&(e=be(e)),e||(e=this.backBuffer.renderToBackBuffer(this.view.texture)),this.runners.prerender.emit(),this.renderTarget.start(e,!0,this.background.colorRgba),this.layer.render(t),this.backBuffer.presentBackBuffer(),this.renderTarget.finish(),this._lastObjectRendered=t,this.runners.postrender.emit()}get resolution(){return this.view.resolution}set resolution(t){this.view.resolution=t}get width(){return this.view.texture.frameWidth}get height(){return this.view.texture.frameHeight}get canvas(){return this.view.element}get lastObjectRendered(){return this._lastObjectRendered}get renderingToScreen(){return!0}get rendererLogId(){return`WebGL ${this.context.webGLVersion}`}};let _=R;_.__systems=[];_.__pipes={};_.__pipesAdaptors={};I.handleByNamedList(m.WebGLRendererSystem,_.__systems);I.handleByMap(m.WebGLRendererPipes,_.__pipes);I.handle(m.WebGLRendererPipesAdaptor,t=>{_.__pipesAdaptors[t.name]={adaptor:t.ref}},t=>{delete _.__pipesAdaptors[t.name]});I.add(...Te,...ot);export{_ as WebGLRenderer};
